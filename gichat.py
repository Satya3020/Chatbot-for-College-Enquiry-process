...
class ChatbotGUI(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("border: 1px solid black; padding: 5px; color:#000000; font-weight:italics; background-image: url('C:/Users/karun/OneDrive/Desktop/py/image12.png'); background-repeat: no-repeat; background-position: center; background-attachment: fixed;")
